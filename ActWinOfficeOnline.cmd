 ...
 * Neu trong qua trinh kich hoat gap loi, Hay thu reset lai file Tokens.dat bang cach sau     
 ...
 # Cac Phien ban duoc Ho tro: 
   ...
   Windows 7 Volume (Vi du: Pro, Enterprise)/8/8.1/10 [Khong ho tro Windows 7 Ultimate]
 ...
 # Tac gia: 
   ...
   Abbodi1406     - Tao tep SppExtComObjPatcher-kms\2-Activate-Local.cmd duoc su dung lam co so
 ...
 - Script Kich hoat Win va Office Online 6 thang: https://bit.ly/KichHoatWindowsVaOfficeOnline
 - Script kich hoat Windows 10 ban quyen Vinh Vien: https://bit.ly/KichHoatBanQuyenVinhVien
 - Kich hoat Ban Quyen So Win10 Pro bang Key Win 7-8-8.1: https://bit.ly/KichHoatW10BangKeyW7W8
 - Sao luu ban quyen Windows va Office: https://bit.ly/SaoLuuBanQuyen
 - Link tai Windows va Office nguyen goc Microsoft: https://bit.ly/LinkTaiISO
 - Link tai cac ban Win10 tu kich hoat ban quyen Vinh Vien: https://bit.ly/ActivateDigitalISO
 - Key Windows 10 va Windows Server - Mac Dinh cua Microsoft: https://bit.ly/KeyGeneric
 - Link tai Win10 Enterprise LTSB 2016 x64 nguyen goc: https://bit.ly/enterpriseLTSB2016x64
 - Link tai Win10 Enterprise LTSB 2016 x32 nguyen goc: https://bit.ly/enterpriseLTSB2016x32
 - Link tai Win10 Enterprise LTSC 2019 x64 nguyen goc: https://bit.ly/LTSC2019x64
 - Link tai Win10 Enterprise LTSC 2019 x32 nguyen goc: https://bit.ly/LTSC2019x32
 - Trang GetLink Fshare cua J2team: http://bit.ly/GetLinkFshare
 - Huong dan toi uu, Fix loi Full Disk 100%: https://bit.ly/FullDisk
 - Phan mem VPN, Fake IP: https://bit.ly/VPNGateClient
 - Phan mem ho tro duyet tab trong Office nhu tren trinh duyet Web: https://bit.ly/OfficeTabver13
 - Key Activate cac phan mem Adobe CS6 cho Windows va MAC: https://bit.ly/KeyCS6
 - Key Eset ban quyen: https://bit.ly/KeyEset
 - Key Kaspersky Internet Security 2019 han den 2020: http://bit.ly/KIS2019
 - Thu thuat cai Win - Fix Loi - Toi Uu... : http://bit.ly/ThuThuatWin
...
setlocal EnableExtensions EnableDelayedExpansion
set "servers="
set "servers=%servers% kms.srv.crsoo.c"
set "servers=%servers%om"
set "servers=%servers% kms.loli.b"
set "servers=%servers%eer"
set "servers=%servers% kms8.MSGuides.c"
set "servers=%servers%om"
set "servers=%servers% kms9.MSGuides.c"
set "servers=%servers%om"
set "servers=%servers% kms.zhuxiaole.o"
set "servers=%servers%or"
set "servers=%servers% kms.lolico.m"
set "servers=%servers%oe"
set "servers=%servers% kms.moeclub.o"
...
set "servers=%servers%om"
set "servers=%servers% hq1.chinancce.c"
set "servers=%servers%om"
set "servers=%servers% kms.library.h"
set "servers=%servers%k"
set "servers=%servers% kms.03k.o"
set "servers=%servers%rg"
set "servers=%servers% cy2617.jios.o"
set "servers=%servers%rg"
set "servers=%servers% kms.cangshui.n"
set "servers=%servers%et"
set "servers=%servers% kms.v0v.b"
set "servers=%servers%id"
set "servers=%servers% kms.jm33.m"
set "servers=%servers%e"
set "servers=%servers% nb.shenqw.w"
set "servers=%servers%in"
set "servers=%servers% kms.izetn.c"
set "servers=%servers%n"
set "servers=%servers% kms.cin.i"
set "servers=%servers%nk"
set "servers=%servers% kms.ijio.n"
set "servers=%servers%et"
set "servers=%servers% kms.iaini.n"
set "servers=%servers%et"
set "servers=%servers% kms.cnlic.c"
set "servers=%servers%om"
set "servers=%servers% kms.51it.w"
set "servers=%servers%ang"
set "servers=%servers% key.17108.c"
set "servers=%servers%om"
set "servers=%servers% kms.ddns.n"
set "servers=%servers%et"
set "servers=%servers% windows.kms.a"
set "servers=%servers%pp"
set "servers=%servers% kms.ddz.r"
set "servers=%servers%ed"
set "servers=%servers% franklv.ddns.n"
set "servers=%servers%et"
set "servers=%servers% kms.mogeko.m"
set "servers=%servers%e"
set "servers=%servers% k.zpale.c"
set "servers=%servers%om"
set "servers=%servers% amrice.t"
set "servers=%servers%op"
set "servers=%servers% m.zpale.c"
set "servers=%servers%om"
set "servers=%servers% mvg.zpale.c"
set "servers=%servers%om"
set "servers=%servers% kms.shuax.c"
set "servers=%servers%om"
set "servers=%servers% xykz.f3322.o"
set "servers=%servers%rg"
set "servers=%servers% kms789.c"
set "servers=%servers%om"
set "servers=%servers% kms.ymgblog.c"
set "servers=%servers%om"
set "servers=%servers% kms.bige0.c"
set "servers=%servers%om"
set "servers=%servers% kms.cz9.c"
set "servers=%servers%n"
set "servers=%servers% kms.ddddg.c"
set "servers=%servers%n"
set "servers=%servers% kms.lotro.c"
set "servers=%servers%c"
set "servers=%servers% zh.us.t"
set "servers=%servers%o"
...
if %loc_off15% equ 0 if %loc_off16% equ 0 (set "aword=Khong duoc Cai dat") else (set "aword=Khong ho tro Kich hoat qua KMS")
wmic path %spp% where (Description like '%%KMSCLIENT%%') get Name 2>nul | findstr /i Office 1>nul && (set office15=1) || (if not defined win7 echo.&echo Phat hien San pham Office 2013/2016/2019 %aword% ...)
wmic path %spp% where (Description like '%%KMSCLIENT%%') get Name 2>nul | findstr /i Windows 1>nul && (set WinVL=1) || (echo.&echo Phat hien Windows Khong ho tro KMS Client...)
...
wmic path %sps% get Version >nul 2>&1 || (echo.&echo Phat hien San pham Office %aword% Khong duoc Cai dat...&exit /b)
wmic path %spp% where (Description like '%%KMSCLIENT%%') get Name >nul 2>&1 || (echo.&echo Phat hien San pham Office %aword% Khong Ho tro Kich hoat qua KMS ...&exit /b)
...
De biet them thong tin Cap nhat ve Script vui long lien he: https://www.facebook.com/HoiQuanCongNgheTinHoc
REM Info End
::
:SetupCompleteFinal
schtasks /create /tn "Online_KMS_Activation_Script-Renewal" /ru "SYSTEM" /xml "%TEMP%\Online_KMS_Activation_Script-Renewal.xml" >nul 2>&1
...
:======================================================================================================================================================
:ScriptUpdates
start https://www.facebook.com/HoiQuanCongNgheTinHoc/posts/1062679867234015/
goto:MAINMENU
